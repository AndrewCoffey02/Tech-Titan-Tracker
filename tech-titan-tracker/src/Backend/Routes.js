...
const client = new Redis("rediss://default:9105239db83042b1b00a4d3d6f8011e5@eu1-becoming-kite-39003.upstash.io:39003");
...
const getLocation = async (city) => {
    ...
    await client.set(`weather: ${city}`, JSON.stringify(response.data))
    //return response
